"""
models/deep_learning/run_cnn_lstm.py
──────────────────────────────────────
CNN-LSTM hybrid training pipeline orchestration.

Run from project root:
    python models/deep_learning/run_cnn_lstm.py

Outputs:
    models/deep_learning/saved/cnn_lstm/checkpoint_best.pt
    models/deep_learning/saved/cnn_lstm/checkpoint_last.pt
    models/deep_learning/saved/cnn_lstm/training_history.json
    models/deep_learning/saved/cnn_lstm/model_config.json
    results/deep_learning/cnn_lstm/metrics.json
    results/deep_learning/cnn_lstm/classification_report.txt
    results/deep_learning/cnn_lstm/confusion_matrix.png
    results/deep_learning/cnn_lstm/training_curves.png
"""
...
from models.deep_learning.config import (
    DEVICE, TRAIN_CONFIG, CNN_LSTM_CONFIG, EMBED_DIM, MAX_LEN,
...
from models.deep_learning.lstm_model import load_glove
from models.deep_learning.cnn_lstm_model import CNNLSTMClassifier, save_cnn_lstm_config
...
def main() -> None:
    ...
    save_cnn_lstm_config(dp.vocab_size)
    ...
    evaluator = DLEvaluator(trainer, MODEL_NAME, CNN_LSTM_RESULTS_DIR)
    ...
    if classical_path.exists():
        ...
        print("\n" + "=" * 70)
        print("  COMPARISON (classical + CNN-LSTM)")
        print("=" * 70)
